...
| No date | Heading/count/explanation; No Date at All; divider; Couldn't Read; ledger footer. Main gap/padding 16px, card gap 10px, card padding 8px. | Newsreader uppercase section labels, source provenance, 17px card titles, three icon-and-label actions. Ambiguous card has peach edge, 4px left stripe, warning/help icons and quoted source text; its Give it a date action is dark filled. No accordion hides the groups. |
