...
CLAUDE.md: *"Sushi's time is the scarce resource. Every browser round-trip — load, log in,
...
CLAUDE.md, "Things I have to do (you can't)": load the unpacked extension and report
