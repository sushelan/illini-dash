...
AGENTS.md, Review policy: *"Reviewing `background.ts` as a file had found nothing in four
...
- the question: *how could **this segment** produce exactly this symptom?* — not "review
  this file";
- AGENTS.md's house rules, and the instruction to hunt for *new* classes;
